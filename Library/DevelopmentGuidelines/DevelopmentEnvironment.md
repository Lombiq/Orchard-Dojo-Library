...
- Visual Studio 2015 or later with the following plug-ins (where no download link is supplied you can install the extension from within VS via Extensions and Updates):
	...
	- [Attach To All The Things](https://visualstudiogallery.msdn.microsoft.com/55af87cc-7220-4b4a-b898-be203c1379db) for quickly attaching the debugger to an IIS (Express) and other processes.
